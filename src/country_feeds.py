...
COUNTRY_DESCRIPTIONS = {
    ...
    "Czech Republic": "Czech Republic (Czechia): nationwide HGV restrictions apply on motorways and Class I roads to vehicles over 7.5t, and to vehicles over 3.5t with a trailer/semi-trailer. Sundays and public holidays are restricted 13:00-22:00 year-round. From 1 July to 31 August, Fridays are additionally restricted 17:00-21:00 and Saturdays 07:00-13:00. Statutory exemptions and route-specific rules apply; this feed represents the national restriction calendar only.",
    "Romania": "Romania: route-specific HGV restrictions apply to vehicles over 7.5t on four named road sectors under Order 1249/132/2018: A2 București–Constanța, DN7 Pitești–Râmnicu Vâlcea–Veștem, DN39 Agigea–Mangalia and DN22C Murfatlar–Cernavodă. A2 and DN39 have public-holiday restrictions from 1 April to 30 September; DN7 is restricted on public holidays and their eves year-round. From 1 July to 31 August, additional tourist-season restrictions apply by route and direction: A2 Friday/Saturday București→Constanța and Sunday/Monday Constanța→București, DN7 Friday-Sunday both directions, DN39 Friday-Sunday both directions, and DN22C Sunday Murfatlar→Cernavodă. Statutory exemptions and temporary road-specific measures apply; this feed represents the recurring national route-restriction calendar only.",
    "Switzerland": "Switzerland: a general Sunday and public-holiday driving ban applies to vehicles with a permissible total weight over 3.5t, articulated motor vehicles with a permissible total towing weight over 5t, and vehicles towing a trailer with a permissible total weight over 3.5t. The Sunday/public-holiday ban is 00:00-22:00; a separate nationwide night ban applies every day 22:00-05:00. The driving ban also applies on New Year, Good Friday, Easter Monday, Ascension Day, Whit Monday, 1 August, Christmas Day and 26 December where Christmas does not fall on a Monday or Friday; it does not apply in cantons or parts of cantons where the relevant holiday is not celebrated. Statutory exemptions and special permits apply. This feed represents the recurring nationwide framework; cantonal, route-specific and temporary restrictions are not automatically represented.",
    ...
    "Croatia": "Croatia: freight vehicles over 7.5t (and specified vehicles/combinations over 14m) are restricted on listed state roads and the Split/Zadar ferry-port approaches. Summer restrictions run 15 June-15 September on Saturdays 04:00-14:00 and Sundays 12:00-23:00; public-holiday restrictions also apply, generally 14:00-23:00 on the last day of a holiday and 15:00-23:00 on the eve/Good Friday, with calendar-dependent Sunday rules. The restrictions apply to specified roads rather than Croatian motorways generally; exemptions and route-specific rules apply. A separate Sunday 06:00-22:00 restriction applies on D2 Varaždin–Dubrava Križovljanska. This feed represents the recurring national restriction framework only; temporary road closures and ad-hoc restrictions are not automatically represented.",
}
